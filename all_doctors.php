...
// Fetch all doctors
$doctors = [];
$sql = "SELECT doctor_id, doctor_name, specialization, contact_info FROM doctor ORDER BY doctor_name";
...
<head>
    ...
    <title>All Doctors - AidNexus</title>
...
<body>
    ...
    <div class="main-content">
        <div class="page-header">
            <h2>All Doctors</h2>
            <button class="btn btn-primary" onclick="window.location.href='doctor_add.php'">+ Add New Doctor</button>
        </div>
            ...
            <table>
                ...
                <tbody>
                    <?php if (empty($doctors)): ?>
                        <tr><td colspan="5" style="text-align: center; padding: 40px; color: var(--text-light);">No doctors registered yet.</td></tr>
                    <?php else: ?>
                        <?php foreach ($doctors as $doctor): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="doctor_edit.php?id=<?php echo $doctor['DOCTOR_ID']; ?>" class="action-btn">Edit</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
